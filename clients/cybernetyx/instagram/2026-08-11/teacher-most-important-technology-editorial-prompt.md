# The Teacher Is Still the Most Important Technology

**Creative ID:** `teacher-most-important-technology-editorial`
**DNA merge:** reference-prompt + BRAND_DNA.json + teacher-most-important-technology-editorial.CREATIVE_DNA.json
**Reference prompt:** ../../references/brand-layout/2026-08-11/cybernetyx-brand-editorial-reference-prompt.md
**Calendar ref:** content-calendar.md → slot 3
...
| Body | Panels display. AI assists. But the educator in the room is what turns information into understanding. | #FFFFFF |
| Callout prefix | Hardware changes the tools. | #94A3B8 |
| Callout highlight | Teachers | #3D7BFF |
| Callout suffix | change the experience. | #94A3B8 |
...
Headline upper-left: "The teacher is still" in white, then "the most important technology." in #3D7BFF bold display sans-serif.

Body mid-left in white: "Panels display. AI assists. But the educator in the room is what turns information into understanding."

Callout below body: small educator star icon + "Hardware changes the tools. Teachers change the experience." — "Teachers" in #3D7BFF.

Hero right half: confident educator leading classroom, students engaged in background, warm cinematic lighting, human-centered composition.
...
- Teachers are outdated messaging
...
See teacher-most-important-technology-editorial-post.md
