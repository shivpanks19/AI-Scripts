...
Artifacts written by [clients/swayam/swayam-weekly-automation.md](../swayam-weekly-automation.md) each run. Skills live in [skills/](../../../skills/README.md).
...
Posters upload to GCS via `image-function` using base64 from `{slug}.png`. See `clients/swayam/swayam-weekly-automation.md`.
